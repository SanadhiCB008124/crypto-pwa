        ...
        <div>
            <div className="relative min-h-screen grid bg-primary">
                <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0">
                    ...
                    <div
                        className="relative sm:w-1/2 xl:w-3/5 bg-primary h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden text-white bg-no-repeat bg-cover "
                        style={{
                    ...
                    <div className="md:flex md:items-center bg-primary md:justify-left w-full sm:w-auto md:h-full xl:w-1/2 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none">
                        ...
                        <div className="max-w-xl w-full space-y-12">
                            ...
                            <div
    className="relative md:hidden sm:w-1/2 xl:w-3/5 bg-primary h-full flex-auto items-center justify-center p-10 overflow-hidden text-white bg-no-repeat bg-cover"
