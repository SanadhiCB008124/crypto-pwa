                ...
                <div className="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                    <div className="col-span-12 mt-8">
                        ...
                        <div className="grid grid-cols-12 gap-6 mt-5 mb-5">
                            ...
                            <div className="transform  hover:scale-105 transition duration-300 bg-white text-black shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y ">
